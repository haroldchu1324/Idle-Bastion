...
const HERO_DEFS : Dictionary = {
	...
	"knight": {
		...
		"desc": "A valiant knight who charges into battle.\nEvery 3rd hit throws 2 swords and knocks enemies back.\nKnockback has no effect on bosses.",
	...
	"ranger": {
		...
		"color": Color(0.32, 0.68, 0.30), "effect": "ranger_fire_aura", "idx": 0,
	},
	"guardian": {
		...
		"color": Color(0.58, 0.52, 0.46), "effect": "rock_drop", "idx": 50,
	},
	# Rare
	"arcane_scholar": {
	...
	"frost_herald": {
		...
		"color": Color(0.55, 0.90, 0.98), "effect": "frost_shatter", "idx": 52,
	},
	# Epic
	"storm_knight": {
